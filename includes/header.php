...
<body class="mdui-drawer-body-left mdui-bottom-nav-fixed mdui-appbar-with-toolbar mdui-theme-primary-pink mdui-theme-accent-pink mdui-theme-layout-auto mdui-loaded">
    <header id="appbar" class="mdui-appbar mdui-appbar-fixed">
        ...
        <div class="mdui-toolbar mdui-color-theme">
            ...
            <a target="_BLANK" href="http://cyc.xn--dlqw88b.xn--fiqs8s/" mdui-tooltip="{content: '五成主页'}" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white"><i class="mdui-icon material-icons">code</i></a>
        </div>
    </header>
        ...
        <div class="mdui-list " mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
            ...
            <div class="copyright">
                <div class="mdui-typo">
                    ...
                    <p class="mdui-typo-caption-opacity">© 2023 <a href="http://cyc.xn--dlqw88b.xn--fiqs8s/" target="_blank">五成主页</a></p>
